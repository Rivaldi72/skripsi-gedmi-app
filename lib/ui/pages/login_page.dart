  ...
  Future<void> login(context) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (pesan != '') {
        ...
        prefs.setString('tempat_lahir', data['biodata']['tempat_lahir'] ?? '');
        prefs.setString(
        ...
        prefs.setString('matematika_1', data['biodata']['matematika_1'] ?? '');
        ...
        prefs.setString('matematika_2', data['biodata']['matematika_2'] ?? '');
        ...
        prefs.setString('matematika_3', data['biodata']['matematika_3'] ?? '');
        ...
        prefs.setString('matematika_4', data['biodata']['matematika_4'] ?? '');
        ...
        prefs.setString('matematika_5', data['biodata']['matematika_5'] ?? '');
        ...
        prefs.setString('matematika_6', data['biodata']['matematika_6'] ?? '');
