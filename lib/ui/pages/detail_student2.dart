...
class DetailStudent2 extends StatefulWidget {
  DetailStudent2({Key? key}) : super(key: key);

  @override
  State<DetailStudent2> createState() => _DetailStudent2State();
}

class _DetailStudent2State extends State<DetailStudent2> {
  var menuSiswa;
  Future<void> ambilDataSiswa2() async {
    final response = await http.get(
        Uri.parse('https://ayo-wisuda.site/api/gedmi/siswa/indexsiswa/VIII'));
